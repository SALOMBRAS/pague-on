/* ============================================================
   ...
   ============================================================ */
    ...
    const smartRules = [];
    let ruleEditor = null;
    let state = { tab:'all', chip:'all', query:'', detail:null, installmentModal:null, screen:'home', stockTab:'products', stockFilter:'all', stockQuery:'', stockDetail:null, panel:null, historyFilter:'month', purchaseFilter:'all' };
